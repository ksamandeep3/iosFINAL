...
class CountryViewController: BaseViewController {
    ...
    var countryList = ["Afghanistan","America","Antigua &amp; Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas","Bahrain","Bangladesh","Barbados","Belarus","Belgium","Bosnia &amp; Herzegovina","Botswana","Brazil","British Virgin Islands","Brunei","Bulgaria","Burkina Faso","Mexico","Canada","Cameroon","Cape Verde" ]
